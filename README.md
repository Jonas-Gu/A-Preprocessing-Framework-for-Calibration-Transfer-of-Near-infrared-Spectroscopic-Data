...
- `code_matlab/`
  ...
  - `demo_grid_search.m`: grid-search version of the main workflow. It keeps the same WD calculation and normalized RMSECV-WD selection rule as `demo.m`, but replaces GA candidate-pool generation with exhaustive enumeration.
